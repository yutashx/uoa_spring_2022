...
def main():
    ...
    parser.add_argument('--train_dataset', default="../data/MNIST-flatten/train",
                        help='input train dataset path')
    parser.add_argument('--train_label', default="../data/MNIST-flatten/train_labels.csv",
                        help='input train dataset path')
    ...
    if args.save_model:
        torch.save(model.state_dict(), "block_ai_weight.pt")
